...
class S256Point(Point):
    ...
    def verify(self, z, sig):
        ...
        total = u * G + v * self  #self == P (x,y) x ==r
        #S256Point(x=S256Field(num,prime))
...
#__x = 0x79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798
...
class Signature:
    ...
    # Distinguished Encoding Rules (DER) format is used to encode ECDSA signatures
...
class PublicKey:
    ...
    def __init__(self, secret):
        ...
        self.point = secret * G  # (x,y) S256Point
